...
(
    ...
    'Informática',
    4599.90,
    '{"marca": "TechMais", "cor": "cinza", "memoria_gb": 16, "armazenamento_gb": 512, "sistema": "Linux"}'
),
(
    2,
    'Smartphone X',
    'Telefonia',
    2199.00,
    '{"marca": "Conecta", "cor": "azul", "memoria_gb": 8, "armazenamento_gb": 256, "resistencia_agua": true}'
),
(
    3,
    'Teclado Mecânico',
    'Acessórios',
    349.90,
    '{"marca": "GameTech", "cor": "preto", "layout": "ABNT2", "conexao": "USB", "iluminacao": "RGB"}'
),
(
    4,
    'Monitor UltraWide',
    'Informática',
    1899.90,
    '{"marca": "TechMais", "cor": "preto", "polegadas": 29, "resolucao": "2560x1080", "frequencia_hz": 100}'
);
